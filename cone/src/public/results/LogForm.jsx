...
export default function LogForm({
  ...
  return (
    <div className={styles.form}>
      <div>
        <div className={styles.formLbl} id="lf-rpe">
          RPE (1–10)
        </div>
      ...
      <div>
        <div className={styles.formLbl} id="lf-scale">
          Escala
        </div>
        ...
        <>
          <label className={styles.field}>
            ...
            <input
              ...
              value={inp.perfTime}
              disabled={dis}
              onChange={e => onField('perfTime', e.target.value)}
            />
          </label>
          {blRounds > 0 && (
            <label className={styles.field}>
              ...
              <input
                className={`${styles.perfInput} ${styles.perfInputSm}`}
                type="number"
                min="0"
                max={blRounds}
                inputMode="numeric"
                placeholder={`0/${blRounds}`}
                value={inp.perfRounds}
                disabled={dis}
                onChange={e => onField('perfRounds', e.target.value)}
              />
            </label>
          )}
        </>
        ...
        <div className={styles.numRow}>
          ...
          <label className={styles.field}>
            ...
            <input
              ...
              value={inp.perfReps}
              disabled={dis}
              onChange={e => onField('perfReps', e.target.value)}
            />
          </label>
        </div>
      )}
