...
export default function CheckinSheet({checkinExec,checkinDone,checkinMode,onCheckinMode,checkinSearch,onCheckinSearch,athletes,checkinAthId,onCheckinAthId,checkinAnonName,onCheckinAnonName,checkinSubmitting,onSubmit,onClose}) {
  return(
      ...
      {checkinDone?(
        ...
        <>
          <div className={styles.ckHdr}>
            ...
            <button className={styles.ckClose} onClick={onClose} aria-label="Fechar">✕</button>
          </div>

          <div className={styles.ckModes}>
            <button className={`${styles.ckMode}${checkinMode==='athlete'?' '+styles.ckModeOn:''}`} onClick={()=>onCheckinMode('athlete')}>
              Estou na lista
            </button>
            <button className={`${styles.ckMode}${checkinMode==='anon'?' '+styles.ckModeOn:''}`} onClick={()=>onCheckinMode('anon')}>
              Não estou na lista
            </button>
          </div>
          ...
          <button className={styles.ckGo} onClick={onSubmit}
