  ...
  return (
    <div className={s.card}>
      <div className={s.header}>
        ...
        <a href="index.html" className={s.back} title="Início">
          ← Início
        </a>
      </div>
      ...
      {!hasData ? (
        <div className={s.empty}>
          Nenhum dado encontrado neste navegador.
          <br />
        ...
        <>
          ...
          <a
            className={`${s.btn} ${s.btnDl}`}
            href={blobUrl}
            download={`cone-backup-${today}.json`}
          >
            ⬇ Baixar backup (.json)
          </a>
          ...
          <div className={s.warn}>
            Compartilhe o arquivo baixado (ou o JSON copiado) com o administrador para restaurar os
            dados no Supabase.
          </div>
        </>
      )}
