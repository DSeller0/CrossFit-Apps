...
import {
  ...
  FULL_LIST, exStandard, exScheme, exProg, exProgStepsOnly, exComplex, exDist, exCal, exCardio, exLong, exNoteOnly,
  rlFT, rlDNF, rlAmrap, rlLong, rlMany,
  lbBlMetcon, lbBlForTime, lbBlEstacoes, lbBlBare,
} from '../fixtures.js'
