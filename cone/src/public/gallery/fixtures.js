...
export const exStandard = { id: 'e1', name: 'Thruster', sets: 5, reps: '5', intensity: { mode: 'pct', pct: 75 }, note: 'Quebrar cedo nos thrusters.' }
export const exScheme   = { id: 'e2', name: 'Wall Ball', reps: '21,15,9', intensity: { mode: 'gender', Masculino_RX: '9', Masculino_Inter: '7', Feminino_RX: '6', Feminino_Inter: '5', Masculino_unit: 'kg', Feminino_unit: 'kg' } }
export const exProg     = { id: 'e3', name: 'Back Squat', sets: 5, reps: '3', intensity: { mode: 'progression', steps: [{ reps: '3', load: '70' }, { reps: '3', load: '80' }, { reps: '3', load: '90' }] } }
...
export const exProgStepsOnly = { id: 'e10', name: 'Front Squat', intensity: { mode: 'progression', steps: [{ reps: '5', load: '60' }, { reps: '5', load: '70' }, { reps: '5', load: '80' }] } }
export const exComplex  = { id: 'e4', isComplex: true, name: '', sets: 4, complexMovements: [{ id: 'm1', name: 'Clean Pull', reps: '2' }, { id: 'm2', name: 'Power Clean', reps: '1' }, { id: 'm3', name: 'Push Jerk', reps: '1' }], intensity: { mode: 'pct', pct: 70 } }
export const exDist     = { id: 'e5', name: 'Row', dist: '500', distUnit: 'm' }
export const exCal      = { id: 'e6', name: 'Assault Bike', dist: '15', distUnit: 'cal' }
export const exCardio   = { id: 'e7', name: 'Corrida', intensity: { mode: 'cardio', cardioVal: '400', cardioUnit: 'm' } }
export const exLong     = { id: 'e8', name: 'Dumbbell Devil Press Alternating Bare-Hand', sets: 3, reps: '10', intensity: { mode: 'pct', pct: 60 } }
export const exNoteOnly = { id: 'e9', name: 'Alongamento', note: '2 min cada lado' }

export const FULL_LIST = [exStandard, exScheme, exProg, exComplex, exDist, exCal, exCardio, exLong, exNoteOnly]
...
export const demoMapFull     = new Map([['thruster', { videoUrl: 'https://youtu.be/dQw4w9WgXcQ', videoPublished: true, description: 'Padrão de agachamento com arremesso acima da cabeça.', muscles: 'Pernas, ombros, core.', notes: 'Cotovelos altos na recepção; não deixar o peso cair para frente.' }]])
export const demoMapTextOnly = new Map([['wall ball', { description: 'Agachamento completo com arremesso da bola na parede.' }]])
export const demoMapEmpty    = new Map()
export const demoMapComplex  = new Map([['clean pull', { description: 'Puxada de chão explosiva, sem receber a barra.' }]])
...
export const logPaneAthletes   = [{ id: 'a1', name: 'Bruna' }, { id: 'a2', name: 'Arthur' }]
export const logPaneBlockForm  = [{ blockId: 'b1', blockLabel: 'For Time', blockType: 'For Time', rpe: null, scale: null, perfTime: '', perfRounds: '', perfReps: '' }]
export const logPaneBlockDone  = [{ blockId: 'b1', blockLabel: 'For Time', blockType: 'For Time', rpe: 8, scale: 'RX', perfTime: '12:34', perfRounds: '', perfReps: '' }]

export const deskRegBlFixture = { bl: { type: 'For Time' } }
export const deskRegBlAmrap   = { bl: { type: 'AMRAP' } }

export const checkinAthletes = [{ id: 'a1', name: 'Bruna' }, { id: 'a2', name: 'Arthur' }, { id: 'a3', name: 'Camila' }]

export const bdSess          = { id: 'bds1', sessionName: 'Treino A' }
export const bdBlWodWithAth  = { id: 'bdb1', type: 'For Time', exercises: [exStandard] }
export const bdBlWodIdle     = { id: 'bdb2', type: 'AMRAP', duration: '20', exercises: [exStandard, exProg] }
...
export const sdSessNamed   = { id: 'sds1', sessionName: 'Treino A', blocks: [bdBlWodWithAth, bdBlPlain] }
...
export const rcBlFT    = { id: 'rcb1', type: 'For Time', duration: '12', exercises: [exScheme, exDist] }
export const rcBlFTCap = { id: 'rcb2', type: 'For Time', rounds: 5, duration: '20', exercises: [exStandard, exCal] } // rounds → DNF field
export const rcBlAmrap = { id: 'rcb3', type: 'AMRAP', duration: '20', exercises: [exStandard, exScheme, exDist] }
export const rcBlComplex = { id: 'rcb4', type: 'For Time', label: 'Barra', duration: '15', exercises: [exComplex, exProg] } // complexo: sem `name` próprio
...
export const lbBlForTime = { id: 'lbb2', type: 'For Time', label: 'Fran', duration: '12', exercises: [exScheme, exDist] }
