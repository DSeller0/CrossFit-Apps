...
import {
  ...
  matchesAthlete, toISO,
} from '../../utils/storage';
import { APP_CONFIG } from '../../utils/config';
import PresenterView from '../PresenterView';
import { MONTH_PT } from '../../public/lib/week.js';
import { getWeeksOfMonth } from './publicador/exportHelpers';
import { DailyExportView, WeeklyExportView, WeeklyCalendarExportView, CalendarExportView } from './publicador/exportViews';
...
function SchedulePublisher({ sessions, events, setEvents, athletes, onEditSession, onLogResult }) {
  ...
  const [dvMainTraining, setDvMainTraining] = useState(migEa(_sc.dvMainTraining, '#888888', '#887060'));
  ...
  const [wkMainTraining, setWkMainTraining] = useState(migEa(_sc.wkMainTraining, '#ffffff', '#c8b090'));
  ...
  const [eaDivider, setEaDivider] = useState(migEa(_sc.eaDivider, 'rgba(0,184,212,0.1)', 'rgba(74,200,192,0.1)'));
  ...
  const [mmBlockMetaText, setMmBlockMetaText] = useState(migEa(_sc.mmBlockMetaText, '#000000', '#0d0b09'));
  ...
  const [mmBlockHdr, setMmBlockHdr] = useState(migEa(_sc.mmBlockHdr, 'rgba(0,184,212,0.12)', 'rgba(74,200,192,0.12)'));
  const [mmDivider, setMmDivider] = useState(migEa(_sc.mmDivider, 'rgba(0,184,212,0.1)', 'rgba(74,200,192,0.1)'));
