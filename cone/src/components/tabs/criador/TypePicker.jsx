...
export function CriadorTypePicker({ blockNames, onSelect, onClose }) {
  ...
  const extra = (blockNames || APP_CONFIG.blockNames || []).filter(
    n => n !== '-' && !known.includes(n),
  )
