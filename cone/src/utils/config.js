...
export const ECOL_BASE = {
  ...
  // Blue family
  Força: { text: '#5090e0', bg: '#081428' },
  Strength: { text: '#5090e0', bg: '#081428' },
  LPO: { text: '#4070c0', bg: '#060e20' },
  Core: { text: '#6090d8', bg: '#0a1428' },
  Acessórios: { text: '#4878b8', bg: '#061020' },
  // Green family
  Aquecimento: { text: '#80c040', bg: '#101e08' },
  'Warm-Up': { text: '#80c040', bg: '#101e08' },
  Skill: { text: '#4ac8c0', bg: '#081e1c' },
  Cardio: { text: '#40b878', bg: '#081c10' },
  Mobilidade: { text: '#30a868', bg: '#061a10' },
  Mobility: { text: '#30a868', bg: '#061a10' },
  // Neutral
  Descanso: { text: '#555', bg: '#111' },
  Rest: { text: '#555', bg: '#111' },
  // Gold — Benchmark
  Benchmark: { text: '#d8a840', bg: '#1a1200' },
}
export const ECOL = new Proxy(ECOL_BASE, {
  get: (t, k) =>
    APP_CONFIG.blockColors?.[k]
