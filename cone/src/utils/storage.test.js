...
describe('syncFromSupabase — pull never re-upserts anything it read (#76, #111)', () => {
  test('a full payload across all tables caches to localStorage and calls zero dbSave*', async () => {
    ...
    db.dbLoadResults.mockResolvedValue([
      { id: 'r1', date: '2026-06-24', athleteId: 'a1', sessionId: 's1', blocks: [] },
    ])
    ...
    expect(JSON.parse(globalThis.localStorage.getItem(LS_GOALS))).toEqual({
      athleteGoals: {},
      prs: {},
    })
