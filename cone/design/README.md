...
Each card inlines themes.css + the real component CSS + base64 fonts and carries an 8-theme switcher (4 → 8 with #43/plans/87). Cards are ~350 KB — that's the cost of being self-contained, which is non-negotiable: **Claude Design's CSP blocks every external request** (no CDN, no fonts, no fetch).
...
_43 cards on disk, regenerated 2026-09-18._

| Card | Group | Source | Size |
|---|---|---|---|
| `tokens/palette.html` | tokens | **generated** | 247 KB |
| `tokens/type.html` | tokens | hand-authored | 3 KB |
| `components/afiliados.html` | components | **generated** | 595 KB |
| `components/agenda.html` | components | **generated** | 511 KB |
| `components/atletas.html` | components | **generated** | 607 KB |
| `components/block-cards.html` | components | hand-authored | 2 KB |
| `components/criador.html` | components | **generated** | 502 KB |
| `components/index.html` | components | **generated** | 468 KB |
| `components/leaderboard.html` | components | **generated** | 484 KB |
| `components/me.html` | components | **generated** | 521 KB |
| `components/publicador.html` | components | **generated** | 516 KB |
| `components/resultados.html` | components | **generated** | 520 KB |
| `components/results.html` | components | **generated** | 502 KB |
| `components/schedule.html` | components | **generated** | 528 KB |
| `components/shared.html` | components | **generated** | 594 KB |
| `components/spa.html` | components | **generated** | 497 KB |
| `components/tema.html` | components | **generated** | 466 KB |
| `components/timer.html` | components | **generated** | 458 KB |
| `components/tv-block-card.html` | components | hand-authored | 121 KB |
| `components/tv.html` | components | **generated** | 473 KB |
