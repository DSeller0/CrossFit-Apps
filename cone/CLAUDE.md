...
- Tests: `npm test` (**748 tests across 21 files**, re-measured 2026-08-05 — added `theme` (`public/lib/`, plans/67) and `scheduleHelpers` (`public/schedule/`, plans/68): wod, week, sessions, goals, registry, boxScope, exerciseGroups, resultEntry (`public/lib/`) · entries (`public/`) · meHelpers (`public/me/`) · pix, resultMappers, storage, config (`utils/`) · blockModel, textFormat (`criador/`) · exerciciosHelpers, resultadosHelpers (`components/tabs/`) · useClassTracking (`hooks/`))
