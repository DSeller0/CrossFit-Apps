...
- Tests: `npm test` (**698 tests across 19 files**, re-measured 2026-08-04: wod, week, sessions, goals, registry, boxScope, exerciseGroups, resultEntry (`public/lib/`) · entries (`public/`) · meHelpers (`public/me/`) · pix, resultMappers, storage, config (`utils/`) · blockModel, textFormat (`criador/`) · exerciciosHelpers, resultadosHelpers (`components/tabs/`) · useClassTracking (`hooks/`))
